...
interface StudentDetailEditorProps {
  student: Student
  onSave: (id: string, detail: string) => Promise<void>
}
      ...
      <div className="mt-2 space-y-2">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-md bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 transition-colors cursor-pointer"
          >
            {saving ? (
              <>
          ...
          <button
            ...
            disabled={saving}
            className="text-xs font-medium px-3 py-1.5 rounded-md text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors cursor-pointer"
          >
            Cancelar
          </button>
        </div>
  ...
  return (
    <div className="mt-2 group/detail flex items-start gap-2">
      ...
      <button
        ...
        className="flex-shrink-0 opacity-0 group-hover/detail:opacity-100 focus:opacity-100 p-1 rounded text-zinc-400 hover:text-blue-600 hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-all cursor-pointer"
      >
